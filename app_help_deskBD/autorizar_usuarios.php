...
<body>
  <nav class="navbar navbar-dark bg-dark">
    <a class="navbar-brand" href="home.php">
      <img src="../app_help_deskbd/imagens/autorizar.png" width="30" height="30" class="d-inline-block align-top" alt="">
      App Help Desk
    </a>
    <ul class="navbar-nav">
      <li class="nav-item">
    ...
    <div class="container">
        ...
        <?php
          ...
          if(isset($_GET['usuario']) && $_GET['usuario'] == 'adm'){?>
            ...
            $sql = "SELECT * FROM usuarios where perfil ='Adm' or perfil = 'Tecnico';";
